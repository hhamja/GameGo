...
*/
  ...
  // /*  업데이트 되는 FCM 토큰 스트림으로 받기
  // * 앱 삭제, 재설치 및 앱 데이터 삭제 시 : 기존 토큰 대신 새로운 토큰 발급(업데이트) */
  // Future refreshFcmToken() async {
  //   return await _fcm.onTokenRefresh.listen((fcmToken) {});
  // }

//   /* FCM 포그라운드 수신 */
//   Future foregroundFcm() async {
//     await flutterLocalNotificationsPlugin
//         .resolvePlatformSpecificImplementation<
//             AndroidFlutterLocalNotificationsPlugin>()
//         ?.createNotificationChannel(channel);
...
//   // // 1,2로 푸시 알림을 클릭한 경우, 구체적인 액션 지정하기
